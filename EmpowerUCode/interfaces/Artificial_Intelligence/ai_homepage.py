...
innovation and problem-solving!"
        ...
        self.quiz_ui = QuizUI(master=self.master,master_previous=self,back_button_text="Back to Information Security Homepage",quiz_file_path="./data/quizzes/ai_quiz.txt")
    ...
    def check_ninth_button(self):
        ...
        try:
            self.quiz_ui = QuizUI(master=self.master,master_previous=self,back_button_text="Back to Artificial Intelligence Homepage",quiz_file_path="./data/quizzes/ai_quiz.txt")
            self.quiz_ui = QuizUI(master=self.master,master_previous=self,back_button_text="Back to Artificial Intelligence Homepage",quiz_file_path="./data/quizzes/ai_quiz.txt")
