...
class Receptionist(User):
        ...
        if os.path.exists(path):
            ...
            for line in lines:
                ...
                if input_username == username and input_password == password:
                    return Receptionist(user_id,first_name,last_name,contact_num,username,password,code)
            else:
                return None
        else:
    ...
    def __init__(self,user_id,first_name,last_name,contact_num,username,password,code):
        super().__init__(user_id,first_name,last_name,contact_num,username,password,code)
